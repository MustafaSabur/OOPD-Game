 ...
 * the user can check whether a button is pressed or not, by accessing the static
 * boolean values for each corresponding button.
 * 
...
public class OnScreenButtons{
	...
	/**
	 * holds the values of whether or not the button has been pressed. Use these
	 * to check for input.
	 */
...
//			break;
	...
	public static void disableButton(int buttonId) {
        Log.d("Onscreenbuttons: " + (onScreenButtonsView == null), "");
